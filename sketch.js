...
var player,playerImg,enemy1,enemy2,enemy3,enemy4;
...
function preload(){
 ...
 playerIsRunning = loadAnimation("./assets/player/1.png","./assets/player/2-removebg-preview.png","./assets/player/3-removebg-preview.png","./assets/player/4-removebg-preview.png","./assets/player/5-removebg-preview.png") 
 enemy1Img= loadAnimation("./assets/enemy1/right/1-removebg-preview(1).png","./assets/enemy1/right/1-removebg-preview(2).png","./assets/enemy1/right/1-removebg-preview(3).png")
enemy2Img = loadAnimation("./assets/enemy2/right/enemy2_right1-removebg-preview.png","./assets/enemy2/right/enemy2_right2-removebg-preview.png","./assets/enemy2/right/enemy2_right3-removebg-preview.png","./assets/enemy2/right/enemy2_right4.png","./assets/enemy2/right/enemy2_right5-removebg-preview.png","./assets/enemy2/right/enemy2_right6-removebg-preview.png","./assets/enemy2/right/enemy2_right7-removebg-preview.png")
}
function setup(){
    createCanvas(700,700)
    
    player=createSprite(385,50)
    player.addImage(playerImg)
    player.scale=0.5
   // player.addAnimation(playerIsRunning)
